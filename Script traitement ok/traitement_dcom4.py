...
# Dictionnaire d’équivalence code → nom de champ lisible
field_map = {
    "10:": "date_versement",
...
for line in lines:
    ...
    if len(parts) == 2 and parts[0].isdigit():
        ...
        if current_field:
            # Gérer le champ répétable 'mots_cles_matieres'
...
# Convertir les listes en texte (pour mots-clés)
for rec in records:
...
df_final.to_csv("dcom4_nettoye_champs_explicites.csv", index=False, encoding="utf-8")

print("✅ Fichier structuré sauvegardé sous : dcom4_nettoye_champs_explicites.csv")
